...
from paperi.ui.dropzone import dropzone_caption, wire_dropzone_dnd

_DROPZONE_FG_COLOR = ("gray85", "gray20")


class EmptyStatePanel(ctk.CTkFrame):
    """paperi-spec.md §7.4: the "empty" state shown before any file is
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ctk.CTkLabel(header, text="Paperi", font=ctk.CTkFont(size=16, weight="bold")).pack(
            side="left"
        )
        ctk.CTkButton(
