...
from paperi.infra.bt.bluetoothctl_backend import DiscoveredDevice
from paperi.infra.config_store import ConfigStore
from paperi.infra.history_store import HistoryEntry, HistoryStore
...
from paperi.models.enums import DocumentKind, JobStatus, PrinterModel
from paperi.models.job import PrintJob
from paperi.models.printer_profile import PrinterProfile
from paperi.models.printer_specs import NATIVE_WIDTH_PX, safe_content_width_px
from paperi.services.events import EventType
...
from paperi.ui.empty_state_panel import EmptyStatePanel
from paperi.ui.error_panel import ErrorPanel
from paperi.ui.history_panel import HistoryPanel
from paperi.ui.preview_panel import PreviewPanel
from paperi.ui.printer_panel import PrinterPanel
from paperi.ui.queue_panel import QueuePanel
from paperi.ui.scan_panel import ScanPanel
from paperi.ui.settings_panel import SettingsPanel
from paperi.utils.paths import config_dir
from paperi.utils.version import app_version
...
# produce a wildly wrong ETA) — paperi-spec.md §7.1's own sketch shows
...
class MainWindow(ctk.CTk, TkinterDnD.DnDWrapper):
    ...
    def __init__(
        ...
        # Version in the title (not just "Paperi") so a running
        ...
        self.title(f"Paperi {app_version()}")
    ...
    def _add_documents(self, paths: list[str]) -> None:
        ...
        if not added_any:
            return
        # paperi-spec.md §7.4: transition to the expanded state happens
    ...
    def _handle_clear_queue(self) -> None:
        ...
        # paperi-spec.md §7.4: back to the empty state once the queue
    ...
    def _progress_text(self, job: PrintJob) -> str:
        ...
        been observed to estimate a rate from — paperi-spec.md §7.1's
